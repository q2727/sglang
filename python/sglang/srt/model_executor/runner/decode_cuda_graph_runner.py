    ...
    def __init__(
        ...
        *,
        ...
        if KTRANSFORMERS_AVAILABLE:
            # KT keys its CPU-MoE buffers by flattened tokens, while capture_bs
            # is measured in requests. Preserve shapes registered by other graph
            # runners because every captured graph retains those buffer addresses.
            kt_capture_bs = {bs * self.captured_req_width for bs in self.capture_bs}
